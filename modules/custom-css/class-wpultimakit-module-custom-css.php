<?php
/**
 * Class UltimaKit_Module_Custom_CSS
 *
 * @since 1.0.0
 * @package    UltimaKit
 */
 ...
 * @since 1.0.0
 */
class UltimaKit_Module_Custom_CSS extends UltimaKit_Module_Manager {
	/**
	 * @var string
	 */
	protected $ID = 'ultimakit_module_custom_css';
	 ...
	 * @var string
	 */
	protected $read_more_link = 'add-custom-css-in-wordpress';
	...
	public function __construct() {
		$this->name        = __( 'Custom CSS', 'ultimakit-for-wp' );
		$this->description = __( 'Add Custom CSS on Frontend.', 'ultimakit-for-wp' );
	...
	public function add_css(){
		echo '<!--This CSS has been generated by UltimaKit.-->';
		echo '<style>';
		echo $this->getModuleSettings( $this->ID, 'custom_css' );
		echo '</style>';
	}
	...
	public function add_modal() {
		...
		$arguments['title'] = __( 'Custom CSS', 'ultimakit-for-wp' );

		$arguments['fields'] = array(
			'custom_css'          => array(
				'type'  => 'textarea',
				'label' => __( 'Custom CSS', 'ultimakit-for-wp' ),
				'value' => $this->getModuleSettings( $this->ID, 'custom_css' ),
			),
			'location'          => array(
				'type'  => 'select',
